...
public class BluToast {
    ...
    public BluToast(Context context) {
...
//    public static BluToast makeText(Context context, CharSequence text, int duration) {
//        Toast toast = Toast.makeText(context, text, Toast.LENGTH_SHORT);
//        BluToast exToast = new BluToast(context);
//        exToast.toast = toast;
//        exToast.mDuration = duration;
//        return exToast;
//    }

//    public static BluToast makeText(Context context, int resId, int duration) throws Resources.NotFoundException {
