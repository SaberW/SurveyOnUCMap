...
public class PrintDrawable extends Drawable implements IPrint {
    ...
    private PrintDrawable(Context context, CharSequence iconText, ColorStateList iconColor, Typeface iconFont, int iconSize, boolean inEditMode) {
        mContext = context;
        mPaint = new Paint();
    ...
    public void setIconSizeRes(@DimenRes int resId) {
        setIconSize(TypedValue.COMPLEX_UNIT_PX, mContext.getResources().getDimensionPixelSize(resId));
    }
    ...
    public void setIconSize(int unit, float size) {
        mIconSize = (int) TypedValue.applyDimension(unit, size, mContext.getResources().getDisplayMetrics());
        mPaint.setTextSize(mIconSize);
        invalidateSelf();
    }
